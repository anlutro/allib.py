...
def test_paginator_adds_class_to_active_page():
	...
	assert 'class="active"' not in paginator.html_link_for(4)
	assert 'class="active"' in paginator.html_link_for(5)
	assert 'class="active"' not in paginator.html_link_for(6)
